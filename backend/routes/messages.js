...
router.post('/', async (req, res) => {
    try {
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="body">
                            ...
                            <div class="cta">
                                <a href="mailto:${email}?subject=Re: Your message" class="btn">
                                    Reply via Email
                                </a>
                                <a href="https://wa.me/${phone.replace(/[^0-9]/g, '')}" class="btn btn-outline">
                                    WhatsApp
                                </a>
                            </div>
                        </div>
        ...
        transporter.sendMail(mailOptions)
            .then(() => console.log(`📧 Email sent for message from ${name}`))
